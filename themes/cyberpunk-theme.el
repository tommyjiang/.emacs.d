...
(let ((class '((class color) (min-colors 89)))
      ...
      (cyberpunk-purple "#FE00FD")
      (cyberpunk-magenta "#dc8cc3")
      (cyberpunk-tsinghua "#6f1787")
      (cyberpunk-qiuyu "#9900FF")
      (cyberpunk-black "#272822")
      (cyberpunk-black-2 "#0C1021")
      (cyberpunk-black-3 "#0A0A0A")
      (cyberpunk-gray "#d3d3d3")
      (cyberpunk-gray-2 "#898989")
 ...
 (custom-theme-set-faces
   ...
   `(highlight ((,class (:background ,cyberpunk-gray-7))))
   ...
   ;; auctex
   `(font-latex-bold-face ((,class (:foreground ,cyberpunk-green))))
   ...
   ;; company-mode
   `(company-tooltip ((,class (:background ,cyberpunk-gray-5 :foreground ,cyberpunk-white))))
   `(company-scrollbar-bg ((,class (:background ,cyberpunk-gray-5))))
   `(company-scrollbar-fg ((,class (:background ,cyberpunk-gray-5))))
   `(company-tooltip-selection ((,class (:background ,cyberpunk-blue-2 :foreground ,cyberpunk-white-2))))
   `(company-tooltip-common ((,class (:background ,cyberpunk-gray-5 :foreground ,cyberpunk-blue-2))))   
   `(company-tooltip-common-selection ((,class (:background ,cyberpunk-blue-2 :foreground ,cyberpunk-gray-5))))
   `(company-tooltip-annotation ((,class (:background ,cyberpunk-blue-2 :foreground ,cyberpunk-gray-5))))
   `(company-preview-common ((,class (:background ,cyberpunk-blue-2 :foreground ,cyberpunk-white-2))))
   ...
   `(highlight-defined-builtin-function-name-face ((,class (:foreground ,cyberpunk-blue-2))))
   ...
   ;; linum-mode
   `(linum ((,class (:foreground ,cyberpunk-green+2 :background ,cyberpunk-black))))

   ;; ledger-mode
   `(ledger-font-posting-date-face ((,class (:foreground, cyberpunk-pink-1))))
   `(ledger-font-posting-amount-face ((,class (:foreground, cyberpunk-red))))
   `(ledger-occur-xact-face ((,class (:background, cyberpunk-gray-8))))
   `(ledger-font-alias-directive-face ((,class (:foreground, cyberpunk-green))))
   `(ledger-font-payee-uncleared-face ((,class (:foreground, cyberpunk-purple))))
   ...
   ;; mode-line
    `(mode-line-buffer-id ((, class (:background, cyberpunk-black :inverse-video nil))))
    `(mode-line-inactive ((, class (:background, cyberpunk-black))))
    `(mode-line ((, class (:foreground, cyberpunk-gray :background, cyberpunk-black :inverse-video nil))))
    `(sml/global ((, class(:background, cyberpunk-black))))
   `(sml/modes ((, class(:background, cyberpunk-black))))
    `(sml/filename ((, class(:background, cyberpunk-black))))
    `(sml/prefix ((, class(:background, cyberpunk-black))))
   ...
   `(org-agenda-date-today ((,class (:foreground ,cyberpunk-orange-2 :weight bold))))
   `(org-agenda-date-weekend ((,class (:foreground ,cyberpunk-qiuyu))))
   `(org-agenda-calendar-event  ((,class (:foreground ,cyberpunk-orange))))
   `(org-archived ((,class (:slant italic))))
   `(org-checkbox ((,class (:foreground ,cyberpunk-white))))
   ...
   `(org-level-2 ((,class (:foreground ,cyberpunk-orange))))
   `(org-level-3 ((,class (:foreground ,cyberpunk-yellow))))
   `(org-level-4 ((,class (:foreground ,cyberpunk-green))))
   `(org-level-5 ((,class (:foreground ,cyberpunk-blue-5))))
   `(org-level-6 ((,class (:foreground ,cyberpunk-purple))))
   `(org-level-7 ((,class (:foreground ,cyberpunk-pink-2)))) 
   `(org-level-8 ((,class (:foreground ,cyberpunk-orange-2))))
   `(org-link ((,class (:foreground ,cyberpunk-blue-6 :underline t))))
   `(org-tag ((,class (:bold t :weight bold))))
   `(org-column ((,class (:background ,"#272822" :foreground ,cyberpunk-black))))
